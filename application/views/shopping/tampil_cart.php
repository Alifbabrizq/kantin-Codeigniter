<strong><h2>Daftar Belanja</h2></strong>
...
<tr>
<td><?php echo $i++; ?></td>
<td><img style="height: 80px; width: 100px;" class="img-thumbnail" class="img-responsive" src="<?php echo base_url() . 'assets1/img/'.$item['gambar']; ?>"/></td>
